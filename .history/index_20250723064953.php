...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Delete app
    // $appIdToDelete = ID of app you're trying to delete
$conn->prepare("DELETE FROM license_keys WHERE app_id = ?")->bind_param("i", $appIdToDelete)->execute();
$conn->prepare("DELETE FROM apps WHERE id = ?")->bind_param("i", $appIdToDelete)->execute();

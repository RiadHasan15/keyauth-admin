        ...
        <div class="collapse navbar-collapse justify-content-end" id="mainNavbar">
            <ul class="navbar-nav mb-2 mb-lg-0">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle btn btn-secondary text-white mx-1 my-1 my-lg-0" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        Users
                    </a>
                ...
                <li class="nav-item">
                    <a href="logout.php" class="nav-link btn btn-danger text-white mx-1 my-1 my-lg-0">Logout</a>
                </li>
            </ul>
        </div>
    </div>

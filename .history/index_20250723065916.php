...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['add_key'])) {
        ...
        $stmt = $mysqli->prepare("INSERT INTO license_keys (`license_key`, app_id, banned) VALUES (?, ?, 0)");
        if ($stmt) {
    ...
    // Toggle ban/unban license key (using prepared statements)
    ...
    // Toggle HWID ban/unban license key (using prepared statements)

...
// Validate and format the expiration date if provided
if ($expires_at !== null) {
...
try {
    ...
    if ($stmt->execute()) {
        ...
        $logMessage = $expires_at 
            ? "Expiration updated to $expires_at for Key ID $license_key_id" 
            : "Expiration removed for Key ID $license_key_id";

<?php
require_once __DIR__ . '/functions.php';  // Correct path: functions.php is in the same 'admin' directory
requireLogin();
require_once __DIR__ . '/../db.php';     // Correct: db.php is one level above (in root)
